...
const Technologies = () => {
    const { isFetchingTech, isUpdatingTech, isDeletingTech } = useAppSelector(state => state.tech)
        ...
        <DashboardLayout>
            ...
            <div>
                ...
                <div className="card">
                    ...
                    {(isFetchingTech) &&
                        <div className="absolute top-0 left-0 rounded-xl z-40 bg-black/40 w-full h-full items-center justify-center flex">
                            <Loader2 className="animate-spin " />
                        </div>
                    }

                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full gap-4 px-3'>
                        ...
                        {technologies.map((tech, index) => {
                            ...
                            return (
                                <div key={index} className="flex justify-between items-center text-lg h-16 border rounded-2xl bg-[#e6e4e9] px-3">
